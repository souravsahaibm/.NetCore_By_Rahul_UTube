...
namespace SimpleWebApp
{
    public class DependencyService1
    {
        ...
        public DependencyService1(IOpeTransient opeTransient, IOpeScoped opeScoped,IOpeSingleton opeSingleton,IOpeSingletonInstance opeSingletonInstance)
        {
        ...
        public void write()
        {
            Console.WriteLine("From Servcie1: ");
